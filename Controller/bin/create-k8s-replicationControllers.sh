...
/opt/bin/kubectl create -f /home/core/inaetics-demo/k8s/influxdb-grafana-controller.json
/opt/bin/kubectl create -f /home/core/inaetics-demo/k8s/heapster-controller.json
